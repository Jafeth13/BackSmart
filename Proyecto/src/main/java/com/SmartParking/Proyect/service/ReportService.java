...
public class ReportService {
    ...
    public void export1(HttpServletResponse response) throws IOException {
        ...
        Paragraph paragraph = new Paragraph("This is a title1", fontTitle);
    ...
    public void export2(HttpServletResponse response) throws IOException {
        ...
        Paragraph paragraph = new Paragraph("This is a title2", fontTitle);
        paragraph.setAlignment(Paragraph.ALIGN_CENTER);
    ...
    public void export3(HttpServletResponse response) throws IOException {
        ...
        Paragraph paragraph = new Paragraph("This is a title3", fontTitle);
        paragraph.setAlignment(Paragraph.ALIGN_CENTER);
